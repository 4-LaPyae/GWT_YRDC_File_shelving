...
//$PHPTHUMB_CONFIG['document_root'] = 'd:\\Hosting\\3073330\\html'; // for server
...
$PHPTHUMB_CONFIG['document_root'] = $g_upload_path;
...
$PHPTHUMB_CONFIG['high_security_password']   = 'fewfewfe!@#34344546berbrentrjjrtjglobalewgg43g43t3wrgrgerg';     // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpThumb.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
...
function phpThumbURL($ParameterString) {
	...
	//return str_replace(@$PHPTHUMB_CONFIG['document_root'], '', dirname(__FILE__)).'../library/phpThumb.php?'.$ParameterString.'&hash='.md5($ParameterString.@$PHPTHUMB_CONFIG['high_security_password']);
	return 'library/phpThumb.php?'.$ParameterString.'&hash='.md5($ParameterString.@$PHPTHUMB_CONFIG['high_security_password']);		
}
///////////////////////////////////////////////////////////////////////////////
