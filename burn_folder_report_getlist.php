<?php
	...
	$_SESSION['SESS_BURN_FOLDER_SORTINGCOLS_MLR'] = $SortingCols;	//to get sorting in export file 

	$rResult = $report_bol->select_folder_burn_report_list($DisplayStart, $DisplayLength, $SortingCols, $cri_arr);	
