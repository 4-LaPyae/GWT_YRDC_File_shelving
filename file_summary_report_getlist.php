<?php
	...
	$_SESSION['SESS_SUMMARY_FILE_SORTINGCOLS_MLR'] = $SortingCols;	//to get sorting in export file 

	$rResult = $report_bol->select_file_summary_report_list($DisplayStart, $DisplayLength, $SortingCols, $cri_arr);	
	...
	if( $rResult->rowCount() > 0 )
	{
		...
		// စုစုပေါင်း		
		$response['aaData'][] = total_file_summary_report();
	}
